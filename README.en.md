...
## ⚡ Quick Start: vhstack Full Install

A single command sets up the entire vhstack environment (prompt, Tmux, Neovim)
on your server. The script and its documentation live in the central
