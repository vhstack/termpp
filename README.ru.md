...
# <img src="assets/vhstack.svg" width="28" height="28" alt="vhstack" style="vertical-align:middle; margin-right: 6px;" /> termpp — терминал, Nerd Font и prompt

[![Version](https://img.shields.io/github/v/tag/vhstack/termpp?label=version&sort=semver&color=8b8fd9)](https://github.com/vhstack/termpp/tags)
